...
#endif
static const char *ng0 = "//ece-homes.ece.wpi.edu/ssargent/ECE 2029/Lab3/Hex2Seg.v";
...
LAB20:    t543 = (t0 + 3176);
    ...
    *((unsigned int *)t553) = (t555 | t549);
    xsi_driver_vfirst_trans(t543, 0, 6);
    t556 = (t0 + 3096);
    *((int *)t556) = 1;
...
LAB16:    xsi_vlog_unsigned_bit_combine(t3, 7, t33, 7, t38, 7);
    goto LAB20;
...
LAB33:    xsi_vlog_unsigned_bit_combine(t38, 7, t69, 7, t74, 7);
    goto LAB37;
...
LAB50:    xsi_vlog_unsigned_bit_combine(t74, 7, t105, 7, t110, 7);
    goto LAB54;
...
LAB67:    xsi_vlog_unsigned_bit_combine(t110, 7, t141, 7, t146, 7);
    goto LAB71;
...
LAB84:    xsi_vlog_unsigned_bit_combine(t146, 7, t177, 7, t182, 7);
    goto LAB88;
...
LAB101:    xsi_vlog_unsigned_bit_combine(t182, 7, t213, 7, t218, 7);
    goto LAB105;
...
LAB114:    t249 = ((char*)((ng12)));
    goto LAB115;

LAB116:    t256 = (t0 + 1048U);
    t257 = *((char **)t256);
    t256 = ((char*)((ng13)));
    memset(t258, 0, 8);
    t259 = (t257 + 4);
...
LAB118:    xsi_vlog_unsigned_bit_combine(t218, 7, t249, 7, t254, 7);
    goto LAB122;
...
LAB135:    xsi_vlog_unsigned_bit_combine(t254, 7, t285, 7, t290, 7);
    goto LAB139;
...
LAB148:    t321 = ((char*)((ng1)));
    goto LAB149;

LAB150:    t328 = (t0 + 1048U);
    t329 = *((char **)t328);
    t328 = ((char*)((ng16)));
    memset(t330, 0, 8);
    t331 = (t329 + 4);
...
LAB152:    xsi_vlog_unsigned_bit_combine(t290, 7, t321, 7, t326, 7);
    goto LAB156;
...
LAB169:    xsi_vlog_unsigned_bit_combine(t326, 7, t357, 7, t362, 7);
    goto LAB173;
...
LAB186:    xsi_vlog_unsigned_bit_combine(t362, 7, t393, 7, t398, 7);
    goto LAB190;
...
LAB199:    t429 = ((char*)((ng20)));
    goto LAB200;

LAB201:    t436 = (t0 + 1048U);
    t437 = *((char **)t436);
    t436 = ((char*)((ng17)));
    memset(t438, 0, 8);
    t439 = (t437 + 4);
...
LAB203:    xsi_vlog_unsigned_bit_combine(t398, 7, t429, 7, t434, 7);
    goto LAB207;
...
LAB216:    t465 = ((char*)((ng21)));
    goto LAB217;

LAB218:    t472 = (t0 + 1048U);
    t473 = *((char **)t472);
    t472 = ((char*)((ng22)));
    memset(t474, 0, 8);
    t475 = (t473 + 4);
...
LAB220:    xsi_vlog_unsigned_bit_combine(t434, 7, t465, 7, t470, 7);
    goto LAB224;
...
LAB237:    xsi_vlog_unsigned_bit_combine(t470, 7, t501, 7, t506, 7);
    goto LAB241;
...
LAB250:    t537 = ((char*)((ng25)));
    goto LAB251;

LAB252:    t542 = ((char*)((ng26)));
    goto LAB253;

LAB254:    xsi_vlog_unsigned_bit_combine(t506, 7, t537, 7, t542, 7);
    goto LAB258;
...
extern void work_m_00000000004210437608_3697081261_init()
{
	static char *pe[] = {(void *)Cont_27_0,(void *)Cont_43_1};
	xsi_register_didat("work_m_00000000004210437608_3697081261", "isim/Hex2seg_Test_isim_beh.exe.sim/work/m_00000000004210437608_3697081261.didat");
