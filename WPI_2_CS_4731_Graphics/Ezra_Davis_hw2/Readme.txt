...
Building/Running:
The program should simply be setup to compile and run in visual studio (the sln file is in graphics_starting_code_2).
...
Code Organization:
All the code is in the graphics_starting_code_2/GLSLExperiment
