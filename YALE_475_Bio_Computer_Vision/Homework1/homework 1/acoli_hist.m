...
%   random angle between 20 and 90 degrees).
...
%%
  function newacoli = update_bacterium(acoli, food, dt)
    ...
    if acoli.mode == 0 % Run
      ...
      newpos = acoli.pos + dt*newvec; % move one step
    elseif acoli.mode == 1 % Tumble
      ...
      newpos = acoli.pos; % Don't move. Becuase it is in tumble state.
    end
    
%     newpos = acoli.pos + dt*newvec;
