...
This project creates a simulation of the Alternating Bit Protocol (rdt3.0) described in our textbook.
...
### Note:
This program was primarily tested with high amounts of packet loss (0.0) corruption (0.9), out-of-order packets (0 to 0.9) and large volumes of packets (1000).
